...
describe 'カラオケ一覧機能' do
  ...
  it '全カラオケ一覧表示' do
    prove(
      ...
      '2016-02-05 16:42:01,ヒトカラ専用ルーム,1.5,快活CLUB 甚目寺店,DAM(LIVE DAM),')
  end
  it 'ログインユーザのカラオケ一覧表示' do
    prove(
      'karaoke/user' , 'ないとさんのカラオケ一覧' , 3 , 
      '2016-01-30 14:00:00,2016年 3/24回目,3.0,歌広場 亀戸店,JOYSOUND(CROSSO)')
  end
  it '指定したユーザのカラオケ一覧表示' do
    prove(
      'karaoke/user/worry' , 'ウォーリーさんのカラオケ一覧' , 1 , 
      '2016-01-08 00:28:00,新年初カラオケ,5.0,JOYJOY 甚目寺店,JOYSOUND(MAX)')
  end

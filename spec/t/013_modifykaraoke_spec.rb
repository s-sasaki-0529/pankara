...
describe 'Karaokeの編集/削除' , :js => true do
  ...
  it '既存カラオケの編集と削除' do
    ...
    expect(old_table[0]['tostring']).to eq '2016-02-13 13:30:00,5.0,カラオケ館 亀戸店,JOYSOUND(f1),55,,'
    ...
    expect(new_table[0]['tostring']).to eq '2020-03-25 20:30:00,12.0,シダックス 盛岡店,JOYSOUND(WAVE),55,,'
    ...
    expect(old_target_row).to eq '2020-03-25,変更後のカラオケ名,12.0,シダックス 盛岡店,JOYSOUND(WAVE),,55,'
